      ...
      <div className="relative bg-[#c71c30] rounded-xl w-full h-screen p-4">
        ...
        <div className="my-5">
          ...
          <div className="w-full grid grid-flow-col space-x-4 overflow-x-scroll no-scrollbar">
            <div className="flex justify-between bg-yellow-400 rounded-2xl w-[17vh] h-[25] p-3 items-center">
        ...
        <div className="my-5">
          ...
          <form>
            <div className="relative">
              ...
              <input type="email" name="floating_email" id="floating_email" className="block  ps-14 p-2.5  w-full text-sm text-[#ffffff] bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer text-[14pt]" placeholder=" Name " required />
            </div>
            <div className="relative">
              <div className="absolute inset-y-0 start-0 flex items-center ps-3.5 pointer-events-none">
              ...
              <input type="email" name="floating_email" id="floating_email" className="block  ps-14 p-2.5  w-full text-sm text-[#ffffff] bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer text-[14pt]" placeholder=" Phone Number " required />
            </div>
          </form>
        </div>
      </div>
